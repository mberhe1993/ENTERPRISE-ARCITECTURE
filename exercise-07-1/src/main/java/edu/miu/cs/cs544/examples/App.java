...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            List<Flight> flights = session.createQuery("from Flight f where f.origin.country='USA' and f.airplane.capacity>500 and f.destination.country<>'USA' ").list();
        ...
        try {
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            List<Flight> flights = session.createQuery("from Flight f where f.airplane.model='747' and f.airline.name<>'Star Alliance' ").list();
        ...
        // d) All flights leaving before 12pm on 08/07/2009  //2009-08-07
        try {
            session = sessionFactory.openSession();
            tx = session.beginTransaction();
            ...
            // TODO update HQL
            @SuppressWarnings("unchecked")
            List<Flight> flights = session.createQuery("from Flight f where f.departureTime<'12:00:00'  and f.departureDate='2009-08-07'  ").list();
